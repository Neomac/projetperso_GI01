...
/* Le sous-programme retournera aleatoirement 1 selon la probabilitÈ choisie, sinon il retournera 0 */
/* (prob est un entier compris entre 0 et 100) */
int random1(int prob)
{
	srand(time(NULL) + rand()); //Initialise alÈatoirement la fonction rand()
